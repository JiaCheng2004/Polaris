...
"""
DeepSeek Reasoner integration module.

This module implements the DeepSeek Reasoner API with the model-agnostic document toolkit.
"""
...
from tools.docs.context_utils import retrieve_relevant_context, build_llm_context
...
def generate_deepseek_response(
    ...
    """
    Generate a response from the DeepSeek Reasoner API.
    
    Args:
        query_text: The user query
        query_context_text: Context from query's attachments and search results
        local_context_text: Retrieved context from vector store
        model_name: The model name (e.g., "deepseek-reasoner")
    ...
    """
    logger.info("Generating DeepSeek response")
