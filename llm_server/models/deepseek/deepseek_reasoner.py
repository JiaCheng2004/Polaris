# models/deepseek/deepseek-reasoner.py
...
def create_deepseek_reasoner_completion(payload: dict, files: List[Any]) -> dict:
    """
    Main function invoked by the /api/v1/chat/completions route
    when 'purpose' == 'discord-bot' and 'model' == 'deepseek-reasoner'.
