...
func (a *BatchAdapter) Output(ctx context.Context, providerJobID string) (io.ReadCloser, error) {
	return nil, httputil.NewError(http.StatusBadRequest, "capability_not_supported", "batch_output_proxy_unavailable", "id", "Google batch output proxy is not implemented in this runtime build.")
}
